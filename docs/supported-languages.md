...
[`Sentencex`](https://github.com/wikimedia/sentencex) from Wikimedia adds even more languages to the mix. It's a bit more relaxed about things, using fallbacks when it doesn't have a perfect match for your language.
